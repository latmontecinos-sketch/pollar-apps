...
export const es = {
  ...
  mode: {
    ...
    explore: "Busco eventos",
    organize: "Organizo eventos",
    chooseTitle: "¿Cómo quieres usar Pollar Pass?",
    chooseSubtitle: "Elige uno. Puedes cambiar de modo cuando quieras.",
    exploreBody: "Descubre eventos, compra entradas y guarda tus pases con QR.",
    organizeBody: "Crea eventos, vende entradas y controla el ingreso en la puerta.",
    exploreTitle: "Encuentra tu próximo evento",
    organizerTitle: "Modo organizador",
    organizerSubtitle: "Tus eventos, tus ventas y la puerta",
    statOnSale: "En venta",
    statSold: "Vendidas",
    statCollected: "Cobrado",
    upcoming: "Tus próximos eventos",
    seeAll: "Ver todos",
    noUpcoming: "No tienes eventos por delante. Crea uno y compártelo.",
    tools: "Herramientas",
    collectedNote: (amount: string) => `${amount} USDC cobrados en todos tus eventos. Llegan directo a tu cuenta.`,
  },
  welcome: {
