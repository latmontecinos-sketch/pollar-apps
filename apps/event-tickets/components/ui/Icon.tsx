/**
 * Small stroke icon set (Lucide-style, 24px grid, `currentColor`), so icons
 * inherit token colors like any text. Add a name + its shapes to extend.
 */
const ICONS = {
  ticket: (
    <>
  ...
  bell: <path d="M10.3 21a1.94 1.94 0 0 0 3.4 0M3.26 15.33A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.67C19.4 13.92 18 12.8 18 8a6 6 0 0 0-12 0c0 4.8-1.4 5.92-2.74 7.33" />,
